...
% for example, an amplitude of the transmitted wave to i-th diffraction order
%  from the substrate to the superstrate under the plane wave illumination
%  with unit amplitude is SM(ind_0+i, ind_0, 2, 1)
%% implementation
function [SM, beta, M2, EV, HV] = fmm(no, kx0, kg, kh, eps1, eps2, FE, pol)
	...
	TS = fmm_calc_T(no,EV,HV,kz1,eps1,pol); % substrate-grating T-matrix
