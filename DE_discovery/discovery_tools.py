...
def set_epde_preprocessor(epde_search_obj: EpdeSearch, use_smoothing: bool, use_ann: bool = False) -> None:
    """
    ...
    Args:
        ...
        use_smoothing: A boolean indicating whether to use the Gaussian smoothing.
        use_ann: A boolean indicating whether to use the ANN preprocessor.
    ...
    if use_ann:
        ...
        epde_search_obj.set_preprocessor(default_preprocessor_type='poly',
                                         preprocessor_kwargs={'use_smoothing': use_smoothing, 'sigma': 1,
                                                              'polynomial_window': 3,
                                                              'poly_order': 3})
...
def epde_discovery(grid: np.ndarray, poynting_vec: np.ndarray, pop_size: int = 5,
                   ...
                   use_smoothing: bool = False, use_ann: bool = False,
                   derivs: [np.ndarray] = None) -> EpdeSearch:
    """
    ...
    Args:
        ...
        use_smoothing: Flag to indicate whether to use Gaussian smoothing (default is False).
    ...
    set_epde_preprocessor(epde_search_obj, use_smoothing=use_smoothing, use_ann=use_ann)
